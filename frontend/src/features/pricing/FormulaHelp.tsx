  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm">
      ...
      <p className="mt-2 text-xs text-slate-500">
        El <strong>margen fijo en euros</strong> no se escribe en la fórmula: se suma a lo que ésta
        dé, sea cual sea. Con los mismos números y 25 céntimos fijos: 14,77€.
      </p>
    </div>
  );
}
