...
describe('ProductDetailPage', () => {
  ...
  it('deletes a product that has no operating history', async () => {
    ...
    expect(confirmSpy).toHaveBeenCalledWith(
      '¿Eliminar definitivamente «Agua 1L»? También se retirarán sus ajustes de stock y lotes de configuración. No es posible después de ventas, compras, devoluciones, mermas o transferencias.',
    );
