...
class SaleLine(IntPrimaryKeyMixin, TimestampMixin, Base):
    ...
    #: Human-readable snapshot for the configured cold-drink supplement. Its
    #: amount remains in ``cold_drink_surcharge`` for backwards compatibility
    #: with the established fiscal calculations.
